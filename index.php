...
<body>
  ...
  <div class="section-2">
    <div class="div-block-5">
      ...
      <div class="div-block-16"><a href="#" class="button-2 w-button">View Our Blog</a></div>
    </div>
  </div>
  <div class="section-3">
        ...
        <div class="slide w-slide">
          <div class="div-block-13">
            <div class="div-block-12">
              <div class="text-block">Enjoy</div>
              <div class="text-block-2">50% off</div>
              <div class="text-block">with this promo code:</div>
              <div class="div-block-15">
                <div class="div-block-14">
                  <div class="text-block-3">View Promo Code</div>
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="section-4">
    <div class="div-block-17">
      <div class="cta">Subscribe to our Newsletter:</div>
      <div class="form-block w-form">
        <form id="email-form" name="email-form" data-name="Email Form" class="form"><input type="email" class="text-field w-input" maxlength="256" name="Email" data-name="Email" placeholder="Enter email address here" id="Email"><input type="submit" value="Submit" data-wait="Please wait..." class="submit-button w-button"></form>
